...
/**
 * Data Governance Exam Grader
 * 
 * This utility grades exam submissions for the Data Governance Primer Exam.
 * 
 * Usage:
 *   node grader.js <submission_file.json>
 *   node grader.js --exam-id <EXAM_ID> --answers <A,B,C,D,...> --student <name>
...
const ANSWER_KEYS = {
    "EXAM-DATAGOVERNANCE-001": {
        name: "Data Governance Primer: A Plain English Guide for Beginners",
...
function printUsage() {
    console.log(`
Data Governance Exam Grader - Usage
===================================
...
Grade from command line:
  node grader.js --exam-id <EXAM_ID> --answers <A,B,C,...> --student <name>
...
Available Exam IDs:
  - EXAM-DATAGOVERNANCE-001  (Data Governance Primer - 20 questions)
`);
}
