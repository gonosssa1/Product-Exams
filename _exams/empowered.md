...
questions:
  ...
  - text: "What are the three dimensions of the coaching framework mentioned in EMPOWERED?"
    options:
      A: "Technical, Business, Design"
      B: "Product Knowledge, Process Skills, People Skills"
      C: "Strategy, Execution, Delivery"
      D: "Vision, Mission, Values"
  - text: "How much time should leaders spend developing people according to EMPOWERED?"
    options:
      A: "10% of their time"
      B: "25% of their time"
      C: "50% or more of their time"
  ...
  - text: "What does the 'Context & Coaching' leadership model emphasize over 'Command & Control'?"
    options:
      ...
      B: "Giving teams problems to solve and measuring outcomes"
      C: "Managing task lists"
      D: "Making all decisions at the top"
...
This exam covers product leadership principles including coaching, empowerment, and the differences between the best product companies and the rest.

**Passing Score:** 70% (7 out of 10 questions)
